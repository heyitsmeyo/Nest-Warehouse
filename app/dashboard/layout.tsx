    ...
    <div className="flex min-h-full flex-col bg-zinc-950 text-zinc-50">
      <header className="sticky top-0 z-30 flex h-16 items-center gap-4 border-b border-zinc-800 bg-zinc-950/80 px-4 backdrop-blur-sm sm:px-6">
        ...
        <div className="flex items-center gap-2">
          <Layers className="h-6 w-6 text-emerald-500" />
          <span className="text-lg font-semibold hidden md:inline-flex">WarehouseOS</span>
        </div>
            ...
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" size="icon" className="rounded-full">
                <Avatar className="h-8 w-8">
                  ...
                  <AvatarFallback className="bg-zinc-800 text-zinc-50">U</AvatarFallback>
                </Avatar>
              </Button>
            </DropdownMenuTrigger>
            <DropdownMenuContent align="end" className="w-56 border-zinc-800 bg-zinc-950 text-zinc-50">
